  ...
  return (
    <div className="min-h-screen dark-gradient-bg">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-20 left-20 w-32 h-32 glass-card animate-liquid-float opacity-60" />
        <div className="absolute bottom-20 right-20 w-24 h-24 glass-card animate-liquid-float opacity-40" style={{animationDelay: '1s'}} />
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          ...
          <p className="text-2xl md:text-3xl font-sf-text font-light text-white/90 mb-4">
            Дублируйте КИЗ за секунды
          </p>
          
          <p className="text-xl font-sf-text text-white/70 mb-12">
      ...
      <section id="scanner" className="py-20 px-6">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-sf font-semibold text-white mb-4">
              Сканировать DataMatrix
            </h2>
            <p className="text-lg text-white/70 font-sf-text">
          ...
          <Card className="glass-card p-8 relative overflow-hidden">
            {scanning && (
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-glass-blue/30 to-transparent animate-scan-wave" />
            )}
            
            <div className="space-y-6">
              {/* Upload Area */}
              <div className="border-2 border-dashed border-white/20 rounded-2xl p-12 text-center hover:border-glass-blue transition-colors cursor-pointer glass-card">
                <Icon name="Upload" size={48} className="mx-auto mb-4 text-white/60" />
                <p className="text-lg font-sf-text text-white/80 mb-2">
                  Перетащите изображение или нажмите для выбора
                </p>
                <p className="text-sm text-white/50">PNG, JPG до 10MB</p>
              </div>
              
              <div className="text-center text-white/50 font-sf-text">или</div>
              ...
              <div className="space-y-4">
                <input
                  ...
                  className="w-full glass-input text-lg py-4"
                />
      ...
      {/* Steps Section */}
      <section className="py-20 px-6 bg-gradient-to-r from-slate-900/50 to-indigo-900/30">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="glass-card p-8 text-center hover:scale-105 transition-transform duration-300">
                ...
                <h3 className="text-xl font-sf font-semibold text-white mb-3">
                  {step.title}
                </h3>
      ...
      {/* Footer */}
      <footer className="py-12 px-6 bg-gradient-to-r from-black/50 to-slate-900/50 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center space-x-6 text-white/60 font-sf-text">
              <span>© 2024 2КИЗ</span>
              <span>•</span>
          ...
          {/* Liquid dock effect */}
          <div className="mt-8 h-1 liquid-gradient rounded-full opacity-70" />
        </div>
      </footer>
    </div>
  );
